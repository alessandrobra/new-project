...
app_label= Label(Frame_tela, textvariable=valor_texto, width=16, height=2, padx=7, relief=FLAT, anchor="e", justify=RIGHT, font=('ivy 18 '), bg=cor3, fg=cor5)
...
b_2.place(x=118, y=0)
b_3=Button(Frame_corpo, command=lambda:entrar_valores('/'), text="/",width=5, height=2, bg=cor2, fg=cor5, font=('ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
b_3.place(x=177, y=0)
...
b_7=Button(Frame_corpo, command=lambda:entrar_valores('*'), text="*",width=5, height=2, bg=cor2, fg=cor5, font=('ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
...
b_11=Button(Frame_corpo, command=lambda:entrar_valores('-'), text="-",width=5, height=2, bg=cor2, fg=cor5, font=('ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
...
b_15=Button(Frame_corpo, command=lambda:entrar_valores('+'), text="+",width=5, height=2, bg=cor2, fg=cor5, font=('ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
...
b_18=Button(Frame_corpo, command= caucular, text="=",width=5, height=2, bg=cor2, fg=cor5, font=('ivy 13 bold'), relief=RAISED, overrelief=RIDGE)
